...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
            >
              {isSubmitting ? (
                <>
      ...
      {/* Map Section */}
      <div className="mt-8">
        <h2 className="text-xl font-bold text-gray-900 mb-4 text-center">Visit Our Office</h2>
        <div className="bg-gray-100 rounded-lg p-6 text-center">
          <div className="w-full h-48 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center text-white">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">BBN Headquarters</h3>
