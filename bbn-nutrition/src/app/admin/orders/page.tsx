  ...
  return (
    <AdminProtectedRoute>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
          <div className="bg-dark-card p-3 rounded-lg border border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-lg font-bold text-dark-text">{orders.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-dark-card p-3 rounded-lg border border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-xs text-dark-text-secondary">Pending Orders</p>
          ...
          <div className="bg-dark-card p-3 rounded-lg border border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-xs text-dark-text-secondary">Shipped Orders</p>
                <p className="text-lg font-bold text-dark-text">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 text-sm bg-dark-gray border border-gray-600 rounded-lg text-dark-text placeholder-dark-text-secondary focus:ring-2 focus:ring-primary focus:border-transparent"
              />
            </div>
            ...
            <select
              ...
              className="px-3 py-1.5 text-sm bg-dark-gray border border-gray-600 rounded-lg text-dark-text focus:ring-2 focus:ring-primary focus:border-transparent"
            >
            ...
            <button
              ...
              className="px-3 py-1.5 text-sm border border-gray-600 text-dark-text-secondary hover:text-primary hover:border-primary rounded-lg transition-colors"
            >
              Clear Filters
            </button>
          </div>
                ...
                {filteredOrders.map((order) => (
                  <tr key={order._id} className="hover:bg-hover-subtle hover:bg-opacity-20 transition-colors">
                    <td className="px-3 py-2 whitespace-nowrap">
                      <div>
                        <div className="text-xs font-medium text-dark-text">{order.orderNumber}</div>
                    ...
                    <td className="px-3 py-2 whitespace-nowrap">
                      <div>
                        <div className="text-xs font-medium text-dark-text">{order.user.name}</div>
                        <div className="text-xs text-dark-text-secondary">{order.user.email}</div>
                      </div>
                    </td>
                    <td className="px-3 py-2 whitespace-nowrap text-xs font-medium text-dark-text">
                    ...
                    <td className="px-3 py-2 whitespace-nowrap">
                      <div className="flex items-center space-x-1">
                        <select
                          ...
                          className={`text-xs font-medium px-1.5 py-0.5 rounded-full border-0 focus:ring-2 focus:ring-primary ${getStatusColor(order.status)}`}
                        >
                          <option value="pending">Pending</option>
                          <option value="confirmed">Confirmed</option>
                          <option value="processing">Processing</option>
                    ...
                    <td className="px-3 py-2 whitespace-nowrap">
                      <span className={`inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium ${getPaymentStatusColor(order.paymentStatus)}`}>
                        {order.paymentStatus}
                      </span>
                    </td>
      ...
      {showOrderDetails && selectedOrder && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-[60] flex items-center justify-center p-2">
          <div className="bg-dark-card rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col border border-gray-700">
            <div className="p-4 border-b border-gray-700 flex items-center justify-between">
              ...
              <button
                ...
                className="p-1 rounded-full hover:bg-hover-subtle hover:bg-opacity-20 transition-colors"
              >
