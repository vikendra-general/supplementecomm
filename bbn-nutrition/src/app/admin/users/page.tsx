  ...
  return (
    <div className="min-h-screen bg-dark-bg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-dark-text">User Management</h1>
                <p className="text-sm text-dark-text-secondary">Manage customer accounts and permissions</p>
              </div>
            </div>
            <button
              onClick={() => setShowUserForm(true)}
              className="bg-gradient-to-r from-primary to-light-green text-dark font-semibold px-4 py-2 rounded-lg hover:from-dark-green hover:to-primary transition-all flex items-center space-x-2"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-dark-card p-4 rounded-lg border border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-xs text-dark-text-secondary">Total Users</p>
                <p className="text-lg font-bold text-dark-text">{users.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-dark-card p-4 rounded-lg border border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-xs text-dark-text-secondary">Active Users</p>
          ...
          <div className="bg-dark-card p-4 rounded-lg border border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-xs text-dark-text-secondary">Admin Users</p>
                <p className="text-lg font-bold text-dark-text">
          ...
          <div className="bg-dark-card p-4 rounded-lg border border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-xs text-dark-text-secondary">Verified Users</p>
                <p className="text-lg font-bold text-dark-text">
        ...
        {/* Search and Filters */}
        <div className="bg-dark-card p-4 rounded-lg border border-gray-700 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            <div className="relative">
              <Search className="absolute left-3 top-2.5 w-4 h-4 text-dark-text-secondary" />
              <input
                type="text"
                placeholder="Search users..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full pl-9 pr-3 py-2 bg-dark-gray border border-gray-600 rounded-lg text-sm text-dark-text placeholder-dark-text-secondary focus:ring-2 focus:ring-primary focus:border-transparent"
              />
            </div>
            ...
            <button
              ...
              className="px-3 py-2 border border-gray-600 text-sm text-dark-text-secondary hover:text-primary hover:border-primary rounded-lg transition-colors"
            >
              Clear Filters
            </button>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-700">
              <thead className="bg-dark-gray">
                <tr>
                  <th className="px-4 py-2 text-left text-xs font-medium text-dark-text-secondary uppercase tracking-wider">
                    User
                  </th>
                  <th className="px-4 py-2 text-left text-xs font-medium text-dark-text-secondary uppercase tracking-wider">
                    Role
              ...
              <tbody className="divide-y divide-gray-700">
                {filteredUsers.map((user) => (
                  <tr key={user._id} className="hover:bg-hover-subtle hover:bg-opacity-20 transition-colors">
                    <td className="px-4 py-3 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="flex-shrink-0 h-8 w-8">
                          <div className="h-8 w-8 rounded-full bg-gradient-to-r from-primary to-light-green flex items-center justify-center">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-dark-text">
